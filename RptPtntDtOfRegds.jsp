...
<table width="100%">
<tr>
	<td align="center"><font color="black" size="7"><U>P<font color="white" size="6">atient <font color="black" size="7">&nbsp;I<font color="white" size="6">nformation</U></td>
</tr>
</table>
...
dtofregd=request.getParameter("cmbdor");
rsData=stmtSelect.executeQuery("select * from eHMS_tblPatient where DtOfRegd='"+dtofregd+"'");
slno=1;
while(rsData.next()){
