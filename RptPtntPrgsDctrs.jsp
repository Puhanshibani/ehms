...
<table width="100%">
<tr>
	<td align="center"><font color="black" size="7"><U>P<font color="white" size="6">atient&nbsp; <font color="black" size="7">P<font color="white" size="6">rogress &nbsp;<font color="black" size="7">I<font color="white" size="6">nformation</U></td>
</tr>
</table>
...
<td nowrap="nowrap"><font size="4"  color="white">Doctors Advice</td>
</tr>
<%
doConnect();
try{
stmtSelect=conn.createStatement();
doctorsNm=request.getParameter("cmbdctnm");
rsData=stmtSelect.executeQuery("select * from eHMS_tblPatientProgress where DoctorsName='"+doctorsNm+"'");
slno=1;
while(rsData.next()){
