...
ResultSet rsData;
String ptntId,refno,date,PtntId,ptntNm,sex,age,locality,city,state,phNo,treatment,roomNo,dept,dctrNm,roomchrg,medicinechrg,otherchrg,totalchrg;
int slno;
...
ptntId=request.getParameter("cmbptntid");
rsData=stmtSelect.executeQuery("select * from eHMS_tblPatientDischarge where PatientId='"+ptntId+"'");
slno=1;
while(rsData.next()){
