...
<form name="f1" action="RptCriticalDepts.jsp" method="post">
<table width="100%">
<tr>
...
<tr>
	<td style="border-radius:60px 0px 0px 0px">
		...
		<td nowrap="nowrap"><font face="Comic Sans MS" color="blue" size="5"><b><center><U>C r i t i c a l &nbsp;&nbsp;&nbsp;  C a r e  &nbsp;&nbsp;&nbsp; H o s p i t a l &nbsp;&nbsp;&nbsp;  P r o f i l e &nbsp;&nbsp; [Any Dept.]</center></b></td></tr>
		</table>
    </td>
</tr>
<tr>
...
rsshowname=stmtshowname.executeQuery("select * from eHMS_tblCritical");
