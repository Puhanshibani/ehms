...
<form name="f1" action="RptPtntPrgsRegdnos.jsp" method="post">
<table width="100%">
<tr>
...
<tr>
	<td style="border-radius:60px 0px 0px 0px">
		...
		<td><font face="Comic Sans MS" color="blue" size="5"><b><center><U>P a t i e n t  &nbsp;&nbsp;&nbsp; P r o g r e s s &nbsp;&nbsp;&nbsp;I n f o m a t i o n  &nbsp;&nbsp; [Any Regd. No.]</center></b></td></tr>
		</table>
    </td>
</tr>
<tr>
...
<tr><td><b>Patient Registration No.</b> </td>
<td><select name="cmbregdno">
<option value="">--select--</option>
<%
doConnect();
try{
stmtshowname=conn.createStatement();
rsshowname=stmtshowname.executeQuery("select * from eHMS_tblPatientProgress");
while(rsshowname.next()){
regdNo=rsshowname.getString("PatientRegNo");
%>
