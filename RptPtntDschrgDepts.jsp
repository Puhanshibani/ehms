...
ResultSet rsData;
String deptNm,refno,date,PtntId,ptntNm,sex,age,locality,city,state,phNo,treatment,roomNo,dept,dctrNm,roomchrg,medicinechrg,otherchrg,totalchrg;
int slno;
...
<table width="100%">
<tr>
	<td align="center"><font color="black" size="7"><U>P<font color="white" size="6">atient&nbsp; <font color="black" size="7">D<font color="white" size="6">ischarge &nbsp;<font color="black" size="7">I<font color="white" size="6">nformation</U></td>
</tr>
</table>
...
<td nowrap="nowrap"><font size="4"  color="white">MedicineChargee</td>
<td nowrap="nowrap"><font size="4"  color="white">OtherCharge</td>
<td nowrap="nowrap"><font size="4"  color="white">TotalCharge</td>
</tr>
<%
doConnect();
try{
stmtSelect=conn.createStatement();
deptNm=request.getParameter("cmbdeptnm");
rsData=stmtSelect.executeQuery("select * from eHMS_tblPatientDischarge where Department='"+deptNm+"'");
slno=1;
while(rsData.next()){
