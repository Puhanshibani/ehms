...
<form name="f1" action="RptPtntPrgsDctrs.jsp" method="post">
<table width="100%">
<tr>
...
<tr>
	<td style="border-radius:60px 0px 0px 0px">
		...
		<td><font face="Comic Sans MS" color="blue" size="5"><b><center><U>P a t i e n t  &nbsp;&nbsp;&nbsp; P r o g r e s s &nbsp;&nbsp;&nbsp;I n f o m a t i o n  &nbsp;&nbsp; [Any Doctor]</center></b></td></tr>
		</table>
    </td>
</tr>
<tr>
...
<td>
<select name="cmbdctnm">
<option value="">--select--</option>
<%
doConnect();
try{
stmtshowname=conn.createStatement();
rsshowname=stmtshowname.executeQuery("select * from eHMS_tbldoctor");
while(rsshowname.next()){
dctrNm=rsshowname.getString("DoctorsName");
%>
