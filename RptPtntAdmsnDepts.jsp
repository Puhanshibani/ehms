...
ResultSet rsData;
String dept,refNo,date,regdno,ptntNm,age,sex,maritalSts,locality,city,phNo,state,trtmnt,hospital,prvDoctor,remark,trtmntFor,dctrNm,department,roomNo;
int slno;
...
rsData=stmtSelect.executeQuery("select * from eHMS_tblPatientAdmin where Department='"+dept+"'");
slno=1;
while(rsData.next()){
