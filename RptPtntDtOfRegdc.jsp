...
<form name="f1" action="RptPtntDtOfRegds.jsp" method="post">
<table width="100%">
<tr>
...
<tr>
	<td style="border-radius:60px 0px 0px 0px">
		...
		<td><font face="Comic Sans MS" color="blue" size="5"><b><center><U>P a t i e n t  &nbsp;&nbsp;&nbsp;  I n f o m a t i o n  &nbsp;&nbsp; [Any Date Of Regd. No.]</center></b></td></tr>
		</table>
    </td>
</tr>
<tr>
...
rsshowname=stmtshowname.executeQuery("select * from eHMS_tblPatient");
while(rsshowname.next()){
det=rsshowname.getString("DtOfRegd");
%>
