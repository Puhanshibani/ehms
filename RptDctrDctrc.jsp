...
<form name="f1" action="RptDctrDctrs.jsp" method="post">
<table width="100%">
<tr>
...
<tr>
	<td style="border-radius:60px 0px 0px 0px">
		...
		<td><font face="Comic Sans MS" color="blue" size="5"><b><center><U>D o c t o r &nbsp;&nbsp;&nbsp; I n f o m a t i o n  &nbsp;&nbsp; [Any Doctor]</center></b></td></tr>
		</table>
    </td>
</tr>
<tr>
