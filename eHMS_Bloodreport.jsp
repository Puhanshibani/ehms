...
<table width="100%">
<tr>
	<td align="center"><img src="home2.png" width="40" height="40" align="left" onclick="goHome()"><font color="black" size="7"><U>P<font color="white" size="6">atient&nbsp; <font color="black" size="7">B<font color="white" size="6">lood&nbsp;<font color="black" size="7">I<font color="white" size="6">nformation</U> </td>
</tr>
</table>
...
rsData=stmtSelect.executeQuery("select * from eHMS_tblBlood");
slno=1;
while(rsData.next()){
