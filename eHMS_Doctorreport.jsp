...
<table width="100%">
<tr>
	<td align="center"><img src="home2.png" width="40" height="40" align="left" onclick="goHome()"><font color="black" size="7"><U>D<font color="white" size="6">octor <font color="black" size="7">&nbsp;I<font color="white" size="6">nformation</U></td>
</tr>
</table>
...
rsData=stmtSelect.executeQuery("select * from eHMS_tbldoctor");
slno=1;
while(rsData.next()){
