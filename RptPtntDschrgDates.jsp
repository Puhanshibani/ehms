...
ResultSet rsData;
String dt,refno,date,PtntId,ptntNm,sex,age,locality,city,state,phNo,treatment,roomNo,dept,dctrNm,roomchrg,medicinechrg,otherchrg,totalchrg;
int slno;
...
dt=request.getParameter("cmbdate");
rsData=stmtSelect.executeQuery("select * from eHMS_tblPatientDischarge where Date='"+dt+"'");
slno=1;
while(rsData.next()){
