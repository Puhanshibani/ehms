...
<form name="f1" action="RptPtntAdmsnRegdnos.jsp" method="post">
<table width="100%">
<tr>
...
<tr>
	<td style="border-radius:60px 0px 0px 0px">
		...
		<td><font face="Comic Sans MS" color="blue" size="5"><b><center><U>P a t i e n t  &nbsp;&nbsp;&nbsp; A d m i s s i o n &nbsp;&nbsp;&nbsp; I n f o m a t i o n  &nbsp;&nbsp; [Any Regd. No.]</center></b></td></tr>
		</table>
    </td>
</tr>
<tr>
...
refno=rsshowname.getString("RegdNo");
%>
